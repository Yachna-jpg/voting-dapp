...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.candidateId) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named candidateId');
    }
    ...
    this.circuits = {
      ...
      endSession: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`endSession: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('endSession',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._endSession_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      endSession: this.circuits.endSession
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('endSession', new __compactRuntime.ContractOperation());
  ...
  _candidateId_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.candidateId(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('candidateId',
                                 'return value',
  ...
  _castVote_0(context, partialProofData) {
    ...
    const cId_0 = this._candidateId_0(context, partialProofData);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _endSession_0(context, partialProofData) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
const _dummyContract = new Contract({
  voterSecret: (...args) => undefined, candidateId: (...args) => undefined
});
